...
//                 <a href="#" className="underline underline-offset-4" onClick={() => setIsSignUp((prev) => !prev)}>
...
//               {/* 👇 2. Add the sign-up switcher here */}
...
//     // 2️⃣ Fetch the user record safely (avoid .single())
...
//     // 3️⃣ If no user record found, optionally create it (optional, depending on your flow)
//     if (!userData) {
...
//       }
//       // Redirect to subscription setup since new user
//       router.push("/workspace/subscription");
//       return;
//     }

//     // 4️⃣ Redirect based on subscription status
...
//                 <h1 className="text-2xl font-bold">Welcome back</h1>
//                 <p className="text-muted-foreground text-balance">
//                   Login to your QualiQ AI account
//                 </p>
//               </div>
...
//             </div>
//           </form>
//           {/* ... your other JSX for the image column ... */}
//         </CardContent>
//       </Card>
//     </div>
//   );
